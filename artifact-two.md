...
<table style="width:100%; border-collapse:collapse; border:none;">
  <tr>
    <td style="width:50%; text-align:center; vertical-align:top; padding:10px; border:none;">
      <img src="assets/breed_outcome_sunburst.png" width="320" style="border-radius:10px;">
      <p style="font-size:0.75rem; color:#9ca3af; line-height:1.3; margin:8px auto 0 auto; max-width:320px;">
        Outcome relationship sunburst chart created by grouping and restructuring data into a parent-child hierarchy, demonstrating how data structures were used to represent category relationships.
      </p>
    </td>

    <td style="width:50%; text-align:center; vertical-align:top; padding:10px; border:none;">
      <img src="assets/outcome_trend.png" width="320" style="border-radius:10px;">
      <p style="font-size:0.75rem; color:#9ca3af; line-height:1.3; margin:8px auto 0 auto; max-width:320px;">
        Outcome trends over time generated by grouping and transforming date-based data, showing how algorithmic processing was used to identify patterns across the dataset.
      </p>
    </td>
  </tr>
</table>
